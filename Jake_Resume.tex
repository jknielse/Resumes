...
\address{980 Seymour St.}{Vancouver, BC}    % optional, remove the line if not wanted
%\mobile{+30 698 4385057}                    % optional, remove the line if not wanted
\phone{(778) 302-6308}                      % optional, remove the line if not wanted
...
\cvline{\textbf{Languages}}{\textbf{Python}, \textbf{Node.js}, Bash, GQL, Swift, Objective-C, C\#, C, C++, Scheme, Assembly}
\cvline{\textbf{Software}}{\textbf{Git}, SVN, Visual Studio, X-Code, Vim, Windows, Linux, Mac}

\section{Work Experience}
\cventry{May 2017 - Present}{Software Engineer (Python, GQL, Javascript)}{\newline{}Dialpad Inc}{Vancouver, BC}{}
...
\cventry{Jan 2016 - Apr 2017}{Full Stack Engineer (Node.js)}{\newline{}JetDiamond Inc}{San Mateo}{}
...
\cventry{Aug 2014 - Dec 2015}{Software Tools Engineer (Python, Swift)}{\newline{}Apple Inc}{Cupertino}{}
...
{Designed the hardware, software, and PID control system for a boat capable of autonomously navigating a water-course.}
